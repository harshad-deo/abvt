...
pub mod abvt {
  ...
  impl<'a> SimStep<'a> {
    ...
    pub fn positions(&self) -> Option<flatbuffers::Vector<'a, f32>> {
      self
        ._tab
        .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f32>>>(SimStep::VT_POSITIONS, None)
    }
    #[inline]
    pub fn score(&self) -> Option<flatbuffers::Vector<'a, f32>> {
      self
        ._tab
        .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f32>>>(SimStep::VT_SCORE, None)
    }
  }
